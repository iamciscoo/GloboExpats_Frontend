    ...
    fields: [
      {
        ...
        label: 'Game Type',
        type: 'text',
        placeholder: 'e.g., Strategy, Family, Party, Puzzle',
        maxLength: 50,
      },
      {
        key: 'ageRange',
      ...
      },
      {
        ...
        type: 'text',
        placeholder: 'e.g., Hasbro, Mattel, Ravensburger',
        maxLength: 50,
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Type',
        type: 'text',
        placeholder: 'e.g., Skincare, Makeup, Haircare, Supplement',
        maxLength: 50,
      },
      {
        key: 'volume',
        label: 'Volume/Weight',
        type: 'text',
        placeholder: 'e.g., 50ml, 100g, 60 capsules',
        maxLength: 30,
      },
      {
        key: 'expiry',
        label: 'Expiry Date',
        type: 'text',
        placeholder: 'e.g., 12/2025, 12M after opening',
        maxLength: 40,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        options: [
          ...
          { value: 'small-pet', label: 'Small Pet (Hamster, Rabbit, etc)' },
          { value: 'other', label: 'Other' },
        ],
      },
      {
