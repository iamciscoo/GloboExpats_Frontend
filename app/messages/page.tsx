...
const messagesData: MessagesData = {
  1: {
    ...
    messages: [
      ...
      { sender: "me", text: "Yes, it's still available! It's in excellent condition, barely used for 2 months.", time: "10:32 AM" },
      {
        sender: "Sarah Mitchell",
  ...
  3: {
    ...
    messages: [
       { sender: "Lisa Wang", text: "What's the battery health?", time: "3 hours ago" },
    ]
  },
  4: {
     product: {
...
export default function MessagesPage() {
  ...
  const activeChat: ChatData = messagesData[selectedConversation.id] || { product: {}, messages: [] };
                ...
                {conversations.map((convo) => (
                  ...
                  >
                    <div className="relative">
                      ...
                      {convo.online && <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-green-500 border-2 border-white" />}
                    </div>
                    <div className="flex-1 flex items-start justify-between">
                      <div className="truncate pr-4">
                        ...
                        <p className="text-xs text-blue-600 font-medium mt-1 truncate">Re: {convo.product}</p>
                      </div>
            ...
            <div className="col-span-2 flex flex-col h-full min-h-0">
              <div className="flex items-center p-4 border-b bg-white flex-shrink-0">
                 <div className="relative">
                    ...
                    {selectedConversation.online && <span className="absolute bottom-0 right-0 block h-2.5 w-2.5 rounded-full bg-green-500 border-2 border-white" />}
                 </div>
                <div className="ml-3">
                    ...
                    <div className="bg-white rounded-lg border p-4 mx-auto max-w-md shadow-sm">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">Condition: {activeChat.product.condition}</p>
                        </div>
                      </div>
                    </div>
                  )}
                  ...
                  {activeChat.messages.map((message: Message, index: number) => (
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className={`text-xs text-muted-foreground mt-1 ${message.sender === 'me' ? 'text-right' : 'text-left'}`}>{message.time}</p>
                      </div>
                      {message.sender === "me" && (
                         <Avatar className="w-8 h-8 border">
              ...
              <div className="p-4 border-t bg-white flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <Button size="icon" className="w-12 h-12 rounded-full bg-blue-500 hover:bg-blue-600 flex-shrink-0">
